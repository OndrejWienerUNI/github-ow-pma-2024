package com.mitch.fontpicker.ui
...
@Composable
fun rememberFontPickerAppState(
    ...
    return remember(navController, snackbarHostState, coroutineScope, networkMonitor) {
        FontPickerAppState(navController, snackbarHostState, coroutineScope, networkMonitor)
    }
}

// Controls app state. Stable -> if any of the values is changed, the Composables are recomposed
@Stable
class FontPickerAppState(
