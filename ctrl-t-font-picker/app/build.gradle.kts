...
val packageName = "com.mitch.fontpicker"

enum class FontPickerBuildType(val applicationIdSuffix: String? = null) {
    Debug(".debug"),
    Staging(".staging"),
    Release
}

enum class FontPickerFlavorDimension {
    Version;

    val dimensionName = this.name.replaceFirstChar { it.lowercase() }
}

enum class FontPickerFlavor(
    val dimension: FontPickerFlavorDimension,
    val applicationIdSuffix: String? = null
) {
    Demo(dimension = FontPickerFlavorDimension.Version),
    Prod(dimension = FontPickerFlavorDimension.Version);
...
android {
    ...
    flavorDimensions += FontPickerFlavorDimension.values().map { it.dimensionName }
    productFlavors {
        FontPickerFlavor.values().forEach { flavor ->
