package com.mitch.christmas.ui
...
fun rememberCristmasAppState(
    ...
    return remember(navController, snackbarHostState, coroutineScope, networkMonitor) {
        ChristmasAppState(navController, snackbarHostState, coroutineScope, networkMonitor)
    }
}

// Controls app state. Stable -> if any of the values is changed, the Composables are recomposed
@Stable
class ChristmasAppState(
