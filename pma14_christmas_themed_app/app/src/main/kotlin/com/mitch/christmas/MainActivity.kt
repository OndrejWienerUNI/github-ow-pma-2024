...
import com.mitch.christmas.ui.designsystem.components.snackbars.ChristmasSnackbarHost
import com.mitch.christmas.ui.designsystem.components.snackbars.toVisuals
import com.mitch.christmas.ui.designsystem.theme.custom.LocalPadding
import com.mitch.christmas.ui.designsystem.theme.custom.padding
import com.mitch.christmas.ui.navigation.ChristmasDestination
import com.mitch.christmas.ui.navigation.ChristmasNavHost
import com.mitch.christmas.ui.rememberCristmasAppState
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CompositionLocalProvider(LocalPadding provides padding) {
                ChristmasTheme(isThemeDark = themeInfo.isThemeDark) {
                    val appState = rememberCristmasAppState(
                        networkMonitor = dependenciesProvider.networkMonitor
                    )

                    Scaffold(
                        snackbarHost = { ChristmasSnackbarHost(appState.snackbarHostState) },
                        ...
                        Box(
                            ...
                            ChristmasNavHost(
                                ...
                                startDestination = ChristmasDestination.Screen.Home
                            )
                        }
                    }
                }
...
private fun themeInfo(uiState: MainActivityUiState): ThemeInfo {
    return when (uiState) {
        ...
        is MainActivityUiState.Success -> {
            val isThemeDark = uiState.theme == ChristmasThemePreference.Dark
            val shouldFollowSystem = uiState.theme == ChristmasThemePreference.FollowSystem
            ThemeInfo(
