package com.mitch.christmas.ui.designsystem.components.dialogs
    ...
    BasicAlertDialog(
        ...
        Surface(
            modifier = Modifier
                .wrapContentWidth()
                .wrapContentHeight(),
            shape = ChristmasDesignSystem.shapes.large,
            ...
            Column(
                ...
                CompositionLocalProvider(LocalContentColor provides titleContentColor) {
                    val textStyle = ChristmasDesignSystem.typography.headlineSmall
                ...
                CompositionLocalProvider(LocalContentColor provides textContentColor) {
                    val textStyle = ChristmasDesignSystem.typography.bodyMedium
                    ProvideTextStyle(textStyle) {
                        Row(
                            modifier = Modifier
