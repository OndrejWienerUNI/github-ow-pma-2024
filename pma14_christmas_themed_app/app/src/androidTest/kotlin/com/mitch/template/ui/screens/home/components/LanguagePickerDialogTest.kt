...
class LanguagePickerDialogTest {
    ...
    fun allLanguageOptionsExist() {
        with(correctItemsRobot) {
            ...
            assertLanguageExists(TemplateLanguagePreference.Czech)
    ...
    fun whenNewSelected_displaysCorrectOption() {
        with(correctItemsRobot) {
            assertLanguageIsSelected(TemplateLanguagePreference.Default)
            selectLanguage(TemplateLanguagePreference.Czech)
            assertLanguageIsSelected(TemplateLanguagePreference.Czech)

            if (TemplateLanguagePreference.Default != TemplateLanguagePreference.Czech) {
