...
android {
    ...
    defaultConfig {
        ...
        androidResources {
            // Enabling 'generateLocaleConfig' to automatically generate the locale configuration.
            // This is intentional to ensure proper locale handling and optimization for dynamic delivery.
    ...
    bundle {
        language {
            // Warning: 'enableSplit' is marked @Incubating. This is intentional because
            // the template manages language selection dynamically, so no splits are needed.
            enableSplit = false
        }
    }
    room {
